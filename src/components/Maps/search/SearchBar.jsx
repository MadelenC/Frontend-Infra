...
export default function SearchBarEntitie({ search, setSearch }) {
  return (
    <div className="flex flex-col md:flex-row justify-start mb-4 gap-2 items-center w-full">
      <input
        type="text"
        placeholder="Buscar por código o placa..."
        value={search}
        onChange={(e) => setSearch(e.target.value)}
        className="h-10 w-full sm:w-80 md:w-96 px-3 text-sm rounded-md border shadow-sm transition

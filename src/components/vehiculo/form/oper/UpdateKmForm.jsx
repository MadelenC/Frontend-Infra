      ...
      <div className="bg-white rounded-lg shadow-md w-full max-w-md p-6 relative  dark:bg-gray-800">
        ...
        <form className="flex flex-col gap-4">
          <div className="flex flex-col">
            <label className="text-sm font-medium text-gray-700 mb-1 dark:text-gray-200">Aumentar (Km)</label>
            <input
              type="number"
              value={increment}
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-gray-700 mb-1 dark:text-gray-200">Km Total</label>
            <input
              type="number"
              value={totalKm}
              readOnly

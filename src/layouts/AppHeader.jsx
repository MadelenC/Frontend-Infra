...
const AppHeader = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-[#1e1f4b] border-b border-[#151735] text-white dark:bg-[#11121f] dark:border-[#1a1a2c] z-50">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        {/* Botón de toggle de sidebar */}
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 sm:gap-4 lg:justify-normal lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-white border-white/20 rounded-lg lg:flex lg:h-11 lg:w-11 lg:border"
